                        ...
                        <Column gap={16} style={{ margin: "24px 0 48px 0" }}>
                            <Column gap={6}>
                                <Row gap={6} verticalAlign="center">
                                    <UserImage src={test} />
                                    <Typography typoSize="B2_medium" color="Gray600">{currentSchedule.nickname}</Typography>
                                </Row>
                                <Row gap={8}>
                                    ...
                                    {currentSchedule.type === "SLEEPOVER" ? (
                                        ...
                                        <Typography typoSize="T4_medium"
                                            color="Gray500">{formatTimeRange(currentSchedule.startDate, currentSchedule.endDate)}</Typography>
                                    )}
                                </Row>
                            </Column>
                            <Column gap={6}>
                                <Typography typoSize="T2_semibold" color="Gray800">{currentSchedule.title}</Typography>
                                <Typography typoSize="B1_medium" color="Gray600">{currentSchedule?.description}</Typography>
                            </Column>
                        </Column>
                        <Row gap={12}>
